...
day(vektor_datetime)
month(vektor_datetime, label = TRUE, abbr = FALSE, locale = "German_Switzerland.1252") # In lokale Sprache ändern
...
wday(vektor_datetime, label = TRUE, abbr = FALSE, week_start = 1, locale = "German_Switzerland.1252")
